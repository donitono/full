...
local function BuildUI()
    ...
    local settingSectionHeight = settingSection.Size.Y.Offset or 180
    local nextSectionY = 5 + settingSectionHeight + 10 -- 10px jarak bawah
    end

    -- Speed Control Section
    local speedSection = Instance.new("Frame", featureScrollFrame)
    speedSection.Size = UDim2.new(1, -10, 0, 80)
    speedSection.Position = UDim2.new(0, 5, 0, nextSectionY or 195)
    ...
    if success and RandomLocationFeature and RandomLocationFeature.CreateUI then
        ...
        randomLocSection.Position = UDim2.new(0, 5, 0, 955) -- di bawah section lain
    else
        warn("RandomLocationFeature gagal dimuat: " .. tostring(RandomLocationFeature))
    end

    -- Set canvas size for feature scroll frame
    featureScrollFrame.CanvasSize = UDim2.new(0, 0, 0, 1300) -- dinaikkan agar muat section baru
