    ...
    function Rayfield:CreateWindow(Settings)
        ...
        Main.Position = UDim2.new(0.5, -280, 0.5, -180)  -- Smaller default position
        Main.Size = UDim2.new(0, 560, 0, 360)             -- Reduced from 600x400 to 560x360
        ...
        Topbar.Size = UDim2.new(1, 0, 0, 22)  -- Further reduced from 25 to 22
        Topbar.Parent = Main
        ...
        function Window:CreateTab(Name, Image)
            ...
            TabButton.TextSize = UIStyle.TabButtonTextSize  -- Now uses smaller size (11)
